...
function getNet() {
  ...
  async function UsePayementChanel() {

    standbyResultField.value = 'submitting the payment transaction...\n';
    ...
    const tx = {
        ...
        "Amount": sendAmount,
        "Destination": operational_wallet,
        "SettleDelay": 86400,
        "PublicKey": "32D2471DB72B27E3310F355BB33E339BF26F8392D5A93D3BC0FC3B566612DA0F0A",
        "CancelAfter": 533171558
    };
    standbyResultField.value += tx;

    client.submitAndWait(tx, {
        autofill: true,
        wallet: standby_wallet,
      }).then(result => {
        standbyResultField.value += result;
      }).catch(error => {
        standbyResultField.value += error;
      });
    client.disconnect();
  }